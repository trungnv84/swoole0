...
The new server is available at: https://b.omg-v2.ravendb.community:28080
The current node ('B') has already been configured and requires no further action on your part.

An administrator client certificate has been installed on this machine (DESKTOP-D1DUT10).
You can now restart the server and access the studio at https://b.omg-v2.ravendb.community:28080.
